...
function Projects(props) {
  return (
      <div className="text-white h-[400px] w-[350px] border-2 border-primary m-5 rounded-[5px] p-5">
        ...
        <h3 className="font-semibold text-lg mt-3">Tech Stack</h3>
        ...
        <h3 className="font-semibold text-lg mt-3  flex">Links</h3>
            <div className="mt-3">
            <button className="btn"><a href={props.veiw}>View Demo</a></button>
            <button className="btn"><a href={props.source}>Source Code</a></button>
            </div>
      </div>
      </div>
